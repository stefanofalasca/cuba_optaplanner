...
public class CubaoptaplannerTestContainer extends TestContainer {

    public CubaoptaplannerTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/cubaoptaplanner/app.properties",
    ...
    public static class Common extends CubaoptaplannerTestContainer {

        public static final CubaoptaplannerTestContainer.Common INSTANCE = new CubaoptaplannerTestContainer.Common();
